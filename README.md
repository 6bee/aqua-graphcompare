...
* Provides hierarchichal and flat deltas
* Allows custom descriptions for types and members
* Allows custom resolution of member values (e.g. enums, foreign keys, etc.)